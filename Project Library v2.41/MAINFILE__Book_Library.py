...
reserve_deletion_button.configure(font="arial 7 bold", pady=0, background="yellow")
...
unreserve_deletion_button.configure(font="arial 7 bold", pady=0, background="#0000ff", fg="yellow")
